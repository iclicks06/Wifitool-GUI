#!/usr/bin/env python3
"""
CachyOS WiFi Tool - GTK3 Version
Compatible with AppIndicator3 and Waybar
"""

import gi

# ⚠️ GTK3 Version Requirements
...
class WiFiTool(Gtk.Window):
    ...
    def __init__(self):
        ...
        # Close window hides to tray (optional)
    ...
    def get_security_type(self, ap):
        ...
        if wpa_flags != NM.AccessPointFlags.NONE or rsn_flags != NM.AccessPointFlags.NONE:
            return "WPA2" if rsn_flags != NM.AccessPointFlags.NONE else "WPA"
